...
import {
  ...
  getWatchlistStockDataAction,
  getWatchlistStockDataDailyAction,
  fetchWatchlists,
...
import {
  ...
  resetSingleStockData,
  resetEntireSingleStock,
} from "../../store/stocks";
...
function StockPage() {
  ...
  const stockCurrentPrice = useSelector(
    (state) => state.stocks.singleStock.CurrentPrice.c
  );
  const stockCurrentPercentChange = useSelector(
    (state) => state.stocks.singleStock.CurrentPrice.dp
  );
  ...
  const handleWatchlistFetchandCheck = async () => {
    await dispatch(fetchWatchlists()).then(() => {
    ...
    <>
      {!loading && user ? (
        <div className="stock-page-container">
          ...
          <div className="stock-page-secondary-stock-info">
            <br></br>

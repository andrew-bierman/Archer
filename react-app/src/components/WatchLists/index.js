...
const Watchlists = () => {
  ...
  const watchListStockData = useSelector(
    (state) => state.watchlists.watchlistStockData
  );
                ...
                <div key={watchlist.id} className="watchlist-individual">
                  <div className="watchlist-individual-name-buttons">
                    {isEditing !== watchlist.id ? (
                      <>
                        <h4 className="watchlist-individual-header">
                          {watchlist.name}
                        </h4>
                      </>
                    ) : (
                      <div className="watchlist-individual-header">
                        <input
                          ...
                          onChange={(event) =>
                            setEdittedWatchlistName(event.target.value)
                          }
                          minLength="1"
                          maxLength="255"
                        ...
                        />
                        <button
                          className="watchlist-individual-button"
                          onClick={() =>
                            handleWatchlistEdit(
                              watchlist.id,
                              edittedWatchlistName
                            )
                          }
                        >
                      ...
                      <button>
                        {showStocks === watchlist.id ? (
                          <i
                            ...
                            onClick={() => setShowStocks(0)}
                          ></i>
                        ) : (
                          <i
                            className="fa-solid fa-angle-right"
                            onClick={() => setShowStocks(watchlist.id)}
                          ></i>
                        )}
                      </button>
                    </div>
                      ...
                      {watchlist?.stocks?.map((stock) => (
                        ...
                        >
                          ...
                          <div className="watchlist-stock-individual-chart">
                            <div>
                              {watchListStockData[stock.symbol]?.dailyData
                                ?.length > 1 ? (
                                <WatchListStockChartMini
                            ...
                            <>
                              {watchListStockData[stock.symbol] ? (
                                ...
                                <div className="watchlist-stock-individual-delete-button">
                                  <button
                                    onClick={() =>
                                      formatWatchlistStockData(stock.symbol)
                                    }
                                  >
                          ...
                          <div>
                            <button
                              className="watchlist-stock-individual-button"
                              onClick={() =>
                                handleWatchlistStockDelete(
                                  watchlist.id,
                                  stock.id
                                )
                              }
